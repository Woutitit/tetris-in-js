...
Tetromino.prototype = {
	determineShape: function(letter) {
		switch(letter) {
		case "I":
		return [[0, 25], [25, 25], [50, 25], [75, 25]];
		break; 
		
		case "O":
		return [[0, 0], [25, 0], [0, 25], [25, 25]];
		break; 
		...
		case "S":
		return [[0, 25], [25, 25], [25, 0], [50, 0]];
		break; 
		
		case "Z":
		return [[0, 0], [25, 0], [25, 25], [50, 25]];
		break; 
		
		case "J":
		return [[0, 0], [0, 25], [25, 25], [50, 25]];
		break;

		case "L":
		return [[50, 0], [0, 25], [25, 25], [50, 25]];
		break;
	}
